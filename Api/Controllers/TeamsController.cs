...
namespace Api.Controllers
{
    ...
    public class TeamsController: ControllerBase
    {
        ...
        {
            var result = await TeamsService.GetTeam(teamId, userId);
        ...
        [Authorize]
        public async Task<ActionResult<TeamOutputDto>> DeleteTeamMember(int teamId, int memberId)
        {
            var result = await TeamsService.DeleteTeamMeber(teamId, memberId, userId);
