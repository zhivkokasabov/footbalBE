...
namespace Core.contracts.Response
{
    public class TournamentOutputDto
    {
        ...
        public string FirstMatchStartsAt { get; set; }
        public string LastMatchStartsAt { get; set; }
        ...
        public bool CanStartTournament { get; set; }
        public bool CanLeaveTournament { get; set; }
