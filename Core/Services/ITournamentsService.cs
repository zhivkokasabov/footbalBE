...
namespace Core.Services
{
    public interface ITournamentsService
    {
        ...
        Task<List<TournamentOutputDto>> GetUserTournaments(int userId, string role);
        ...
        Task<List<ErrorModel>> JoinTournament(int tournamentId, int userId, bool allowAccess = false);
        Task<List<ErrorModel>> LeaveTournament(int tournamentId, int userId);
        ...
        Task<List<ErrorModel>> StartTournament(int tournamentId, int userId);
    }
}
