...
namespace Datum
{
    public class UnitOfWork: IUnitOfWork
    {
        ...
        private TournamentMatchTeamRepository TournamentMatchTeamRepository;
        ...
        public ITournamentMatchTeamRepository TournamentMatchTeams
            => TournamentMatchTeamRepository = TournamentMatchTeamRepository ?? new TournamentMatchTeamRepository(Context);
